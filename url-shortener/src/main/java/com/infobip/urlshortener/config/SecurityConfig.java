...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .and()
            .authorizeRequests().antMatchers(HttpMethod.GET, "/help.html", "/favicon", "/favicon**").permitAll()
            .and()
                .authorizeRequests().mvcMatchers(HttpMethod.GET, "/{shortKey:[a-zA-Z0-9]{1,11}\\b}").permitAll()
            .and()
